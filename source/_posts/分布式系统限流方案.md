...
## 漏桶算法
如图所示：
![漏桶算法图解](https://upyun.zhanghanlun.com/blog/2020/03/1521000115.png)
- 在该模型中有几个参数需要注意，桶的容量B，流出速率R，初始容量F。
- 水（请求）先流入桶（缓存）中，当桶中的水满了的时候，则多余的水会溢出（拒绝请求）。
- 系统根据流出速率来处理请求。
## 令牌桶算法
 如图所示：
<img src="https://upyun.zhanghanlun.com/blog/2020/03/1957153385.jpg" width="60%" height="60%">
...
![artech.png](https://upyun.zhanghanlun.com/blog/2020/03/1873778778.png)
